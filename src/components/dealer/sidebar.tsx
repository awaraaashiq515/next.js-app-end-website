...
const menuGroups: MenuGroup[] = [
    ...
    },
    {
        label: "Inventory",
        items: [
            { name: "My Vehicles", href: "/dealer/vehicles", icon: Car },
            { name: "Add Vehicle", href: "/dealer/vehicles/add", icon: Plus },
        ]
    },
    {
        label: "Subscription",
        items: [
            { name: "My Packages", href: "/dealer/packages", icon: Package },
            { name: "Payments", href: "/dealer/payments", icon: CreditCard },
        ]
    },
    {
        label: "Account",
...
export function DealerSidebar() {
    ...
    const isActive = (href: string) =>
        href === "/dealer" ? pathname === "/dealer" : pathname.startsWith(href)
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <Link href="/dealer" className="flex items-center gap-3 min-w-0" onClick={() => setIsOpen(false)}>
                        ...
                        {!collapsed && (
                            <div className="min-w-0">
                                <p className="font-bold text-white text-[14px] leading-tight truncate">Dealer Portal</p>
                                <p className="text-[10px] leading-tight" style={{ color: '#6b7080' }}>Management Console</p>
                            </div>
                        )}
                    </Link>
                    <button
