    ...
    return (
        <div className="min-h-screen flex" style={{ backgroundColor: '#08090c' }}>
            ...
            <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
                ...
                >
                    {/* Left: mobile hamburger spacer + breadcrumb */}
                    <div className="flex items-center gap-3">
                        {/* Spacer for mobile hamburger button */}
                        <div className="lg:hidden w-10" />
                        <div className="hidden lg:flex items-center gap-2 text-sm" style={{ color: '#6b7080' }}>
                            <span className="font-medium" style={{ color: '#e8a317' }}>Admin</span>
                            <span>/</span>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-2.5 pl-1">
                            ...
                            <div className="hidden sm:block text-left">
                                ...
                                <p className="text-[11px] leading-tight" style={{ color: '#6b7080' }}>Administrator</p>
                            </div>
                        </div>
