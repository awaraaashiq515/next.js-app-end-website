...
export default function EditDealerPackagePage() {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setFormData({
                    ...
                    maxVehicles: pkg.maxVehicles || 0,
                    maxFeaturedCars: pkg.maxFeaturedCars || 0,
                    canAddVehicles: pkg.canAddVehicles ?? true,
                    canFeatureVehicles: pkg.canFeatureVehicles ?? false,
                    listingDuration: pkg.listingDuration || 30,
                    allowPriorityListing: pkg.allowPriorityListing ?? false,
                    allowAnalytics: pkg.allowAnalytics ?? true,
                    allowBulkUpload: pkg.allowBulkUpload ?? false,
            ...
            <div className="mb-10 flex items-center justify-between">
                <div>
                    ...
                    <h1 className="text-3xl font-extrabold text-white uppercase tracking-tight">
                        Edit <span className="text-gray-400">Subscription Plan</span>
                    </h1>
                </div>
            </div>
