...
function PaymentSettings() {
    ...
    if (loading) {
        return <div className="text-center py-20 text-muted-foreground">Loading payment settings...</div>
    }
    ...
    return (
        <div className="space-y-6 mt-4">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                {/* Form Section */}
                <Card className="lg:col-span-2 bg-[#111318] border-white/10">
                    <CardHeader>
                        <CardTitle className="text-white">UPI Configuration</CardTitle>
                        <CardDescription className="text-gray-400">
                    ...
                    <CardContent>
                        <form onSubmit={handleSave} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="upiName" className="text-white">Payee Name *</Label>
                                    <Input
                                        id="upiName"
                                        value={upiName}
                            ...
                            <div className="flex items-center justify-between p-4 border border-white/10 rounded-lg">
                                <div>
                                    <h3 className="font-semibold text-white">Accept UPI Payments</h3>
                                    <p className="text-sm text-muted-foreground">Enable or disable UPI payment option for dealers</p>
                                </div>
                                <Button
                                    type="button"
                ...
                {/* QR Preview Section */}
                <Card className="bg-[#111318] border-white/10 h-fit sticky top-6">
                    <CardHeader>
                        <CardTitle className="text-white flex items-center gap-2">
                            <QrCode className="w-5 h-5" /> QR Preview
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        <div className="bg-white p-6 rounded-xl aspect-square flex items-center justify-center shadow-lg">
                            {qrCodePath ? (
                                <img
                                    src={qrCodePath}
                        ...
                        <div className="space-y-4">
                            <div className="p-4 rounded-lg bg-black/40 border border-white/5">
                                <div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold mb-1">Current Active UPI</div>
                            ...
                            <div className="flex items-start gap-3 p-2">
                                ...
                                <p className="text-[10px] text-gray-500 leading-relaxed">
                                    Changing the UPI ID or Payee Name will automatically regenerate the QR code image for all dealer checkout pages.
                                </p>
                            </div>
                        </div>
                    </CardContent>
