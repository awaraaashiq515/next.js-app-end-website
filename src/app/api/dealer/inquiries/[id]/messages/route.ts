...
/**
 * GET  /api/dealer/inquiries/[id]/messages — get messages
 * POST /api/dealer/inquiries/[id]/messages — send a new dealer message
 */
...
export async function GET(
    ...
    try {
        ...
        console.error("GET /api/dealer/inquiries/[id]/messages error:", error)
...
export async function POST(
    ...
    try {
        ...
        await db.$executeRaw`
            ...
            VALUES (${msgId}, ${id}, 'DEALER', ${user.userId}, ${message.trim()}, ${now}, ${replyToId || null})
        `
        ...
        console.error("POST /api/dealer/inquiries/[id]/messages error:", error)
