...
export default function ClientInsuranceClaimsPage() {
    ...
    const fetchClaims = async () => {
        try {
            setLoading(true)
            // Fetch only WALK_IN claims (created by admin for this client)
            const response = await fetch(`/api/insurance-claims?page=${page}&pageSize=10&source=WALK_IN`)
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p className="mt-1" style={{ color: '#6b7080' }}>Claims processed by our team for you</p>
                </div>
            </div>
            ...
            >
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-20">
                        ...
                        <p className="text-sm text-center max-w-md" style={{ color: '#6b7080' }}>
                            When you visit our center for insurance claim assistance, your claims will appear here.
                        </p>
                    </div>
                ) : (
                    <>
                                    ...
                                    >
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                <button
                                                    onClick={() => router.push(`/client/insurance-claims/${claim.id}`)}
                                                    className="p-2 rounded-lg"
